...
cogitada uma solução hierárquica e distribuída \notice{rfc1034} para a
implementação.
...
O DNS é formado por três elementos principais \notice{rfc1034}:
...
\notice{rfc1034}. Cada nodo deve ter um rótulo, cujo tamanho varia entre 0
...
que um registro tem as seguintes informações \notice{comer}:
...
a árvore do DNS \notice{albitz}. As informações contidas em um servidor de
